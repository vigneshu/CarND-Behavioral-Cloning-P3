...
if not just_checkin_the_data:
    ...
    history = model.fit_generator(train_gen, validation_data=val_gen, nb_val_samples=len(angles_train)/2, samples_per_epoch=len(angles_train), 
                                  nb_epoch=1, verbose=2, callbacks=[checkpoint])#5
